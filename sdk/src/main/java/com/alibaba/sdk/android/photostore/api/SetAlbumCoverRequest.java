...
public class SetAlbumCoverRequest extends BaseRequest {
    private Long id;
    private Long photoId;

    public SetAlbumCoverRequest(Long id, Long photoId) {
        this.id = id;
    ...
    public RpcAcsRequest build() {
        com.aliyuncs.cloudphoto.model.v20170711.SetAlbumCoverRequest request = new com.aliyuncs.cloudphoto.model.v20170711.SetAlbumCoverRequest();
        ...
        request.setActionName("SetAlbumCover");
        return request;
    }

    @Override
    public BaseResponse parse(String result) {
        return JSON.parseObject(result, SetAlbumCoverResponse.class);
    }
}
