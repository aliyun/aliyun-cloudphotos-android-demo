...
public class GetPhotosRequest extends BaseRequest {
    private List<Long> ids;

    public GetPhotosRequest(List<Long> ids) {
        this.ids = ids;
    }

    @Override
    public RpcAcsRequest build() {
        com.aliyuncs.cloudphoto.model.v20170711.GetPhotosRequest request = new com.aliyuncs.cloudphoto.model.v20170711.GetPhotosRequest();
        ...
        request.setActionName("GetPhotos");
        return request;
    }

    @Override
    public BaseResponse parse(String result) {
        return JSON.parseObject(result, GetPhotosResponse.class);
    }
}
