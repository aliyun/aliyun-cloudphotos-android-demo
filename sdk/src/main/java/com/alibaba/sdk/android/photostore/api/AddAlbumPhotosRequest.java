...
public class AddAlbumPhotosRequest extends BaseRequest {
    ...
    public AddAlbumPhotosRequest(Long id, List<Long> photoIds) {
        this.id = id;
    ...
    public RpcAcsRequest build() {
        com.aliyuncs.cloudphoto.model.v20170711.AddAlbumPhotosRequest request = new com.aliyuncs.cloudphoto.model.v20170711.AddAlbumPhotosRequest();
        ...
        request.setActionName("AddAlbumPhotos");
        return request;
    }

    @Override
    public BaseResponse parse(String result) {
        return JSON.parseObject(result, AddAlbumPhotosResponse.class);
    }
}
