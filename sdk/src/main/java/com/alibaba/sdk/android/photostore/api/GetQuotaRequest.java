...
public class GetQuotaRequest extends BaseRequest {
    @Override
    public RpcAcsRequest build() {
        com.aliyuncs.cloudphoto.model.v20170711.GetQuotaRequest request = new com.aliyuncs.cloudphoto.model.v20170711.GetQuotaRequest();
        ...
        request.setActionName("GetQuota");
        return request;
    }

    @Override
    public BaseResponse parse(String result) {
        return JSON.parseObject(result, GetQuotaResponse.class);
    }
}
