...
public class RemoveAlbumPhotosRequest extends BaseRequest {
    private Long id;
    private List<Long> photoIds;

    public RemoveAlbumPhotosRequest(Long id, List<Long> photoIds) {
        this.id = id;
    ...
    public RpcAcsRequest build() {
        com.aliyuncs.cloudphoto.model.v20170711.RemoveAlbumPhotosRequest request = new com.aliyuncs.cloudphoto.model.v20170711.RemoveAlbumPhotosRequest();
        ...
        request.setActionName("RemoveAlbumPhotos");
        return request;
    }

    @Override
    public BaseResponse parse(String result) {
        return JSON.parseObject(result, RemoveAlbumPhotosResponse.class);
    }
}
