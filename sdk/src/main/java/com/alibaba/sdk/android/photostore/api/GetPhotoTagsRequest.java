...
public class GetPhotoTagsRequest extends BaseRequest {
    private Long id;

    public GetPhotoTagsRequest(Long id) {
        this.id = id;
    }

    @Override
    public RpcAcsRequest build() {
        com.aliyuncs.cloudphoto.model.v20170711.ListPhotoTagsRequest request = new com.aliyuncs.cloudphoto.model.v20170711.ListPhotoTagsRequest();
        ...
        request.setActionName("ListPhotoTags");
        return request;
    }

    @Override
    public BaseResponse parse(String result) {
        return JSON.parseObject(result, GetPhotoTagsResponse.class);
    }
}
