...
public class GetThumbnailRequest extends BaseRequest {
    ...
    public GetThumbnailRequest(Long photoId, String zoomType) {
    ...
    public RpcAcsRequest build() {
        com.aliyuncs.cloudphoto.model.v20170711.GetThumbnailRequest request = new com.aliyuncs.cloudphoto.model.v20170711.GetThumbnailRequest();
        ...
        request.setActionName("GetThumbnail");
        return request;
    }

    @Override
    public BaseResponse parse(String result) {
        return JSON.parseObject(result, GetThumbnailResponse.class);
    }
}
