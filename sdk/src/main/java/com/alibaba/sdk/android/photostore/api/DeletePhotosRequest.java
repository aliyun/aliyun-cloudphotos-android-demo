...
public class DeletePhotosRequest extends BaseRequest {
    private List<Long> ids;

    public DeletePhotosRequest(List<Long> idss) {
        this.ids = idss;
    }

    @Override
    public RpcAcsRequest build() {
        com.aliyuncs.cloudphoto.model.v20170711.DeletePhotosRequest request = new com.aliyuncs.cloudphoto.model.v20170711.DeletePhotosRequest();
        ...
        request.setActionName("DeletePhotos");
        return request;
    }

    @Override
    public BaseResponse parse(String result) {
        return JSON.parseObject(result, DeletePhotosResponse.class);
    }
}
