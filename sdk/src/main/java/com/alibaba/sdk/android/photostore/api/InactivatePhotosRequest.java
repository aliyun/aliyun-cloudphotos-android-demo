...
public class InactivatePhotosRequest extends BaseRequest {
    private List<Long> ids;

    public InactivatePhotosRequest(List<Long> idss) {
        this.ids = idss;
    }

    @Override
    public RpcAcsRequest build() {
        com.aliyuncs.cloudphoto.model.v20170711.InactivatePhotosRequest request = new com.aliyuncs.cloudphoto.model.v20170711.InactivatePhotosRequest();
        ...
        request.setActionName("InactivatePhotos");
        return request;
    }
