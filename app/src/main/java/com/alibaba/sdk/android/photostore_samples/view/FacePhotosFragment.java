...
import com.alibaba.sdk.android.photostore_samples.adapter.FacePhotosAdapter;
...
public class FacePhotosFragment extends BaseFragment {

    String TAG = FacePhotosFragment.class.getSimpleName();
    ...
    public static FacePhotosFragment newInstance() {
        return new FacePhotosFragment();
    }

    public FacePhotosFragment() {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        what = ContentType.FACE_PHOTO.ordinal();
        Bundle bundle = getArguments();
        if (bundle != null) {
            what = bundle.getInt("what", ContentType.FACE_PHOTO.ordinal());
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        if (adapter == null) {
            adapter = new FacePhotosAdapter(getActivity(), cols);
        ...
        if (what == ContentType.FACE_PHOTO.ordinal()) {
    ...
    void loadData() {
        Log.d(TAG, "loadData");
        if (what == ContentType.FACE_PHOTO.ordinal()) {
            PhotosController.getInstance().updateFacePhotos(id);
            adapter.setFaceId(id);
        }
    }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case NOTIFY_DATA_CHANGED:
                    adapter.buildData(new FacePhotosAdapter.BuildDataCallback() {
                        @Override
    ...
    public void movePhotosToFace () {
        adapter.movePhotosToFace();
    }

    @Subscribe
    public void onGetFacesPhotos(OnGetFacesPhotosEvent event) {
        MyFacePhoto.getByFace(id, new DatabaseCallback<MyPhoto>() {
            @Override
